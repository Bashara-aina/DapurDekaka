...
async function seed() {
  ...
  const settings = [
    ...
    { key: 'biteship_origin_lat', value: '-6.958', type: 'string' },
    { key: 'biteship_origin_lng', value: '107.636', type: 'string' },
    { key: 'biteship_origin_address', value: 'Jl. Sinom V No. 7, Turangga, Bandung, Jawa Barat', type: 'string' },
    { key: 'biteship_origin_postal_code', value: '40264', type: 'string' },
