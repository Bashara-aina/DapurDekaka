...
export default function AdminBlogNewClient() {
  ...
  useEffect(() => {
    ...
    const autoGeneratedSlug = watchedTitleId ? generateSlug(watchedTitleId) : '';
    if (!currentSlug && watchedTitleId) {
      form.setValue('slug', autoGeneratedSlug, { shouldValidate: true });
    } else if (currentSlug === autoGeneratedSlug && watchedTitleId) {
