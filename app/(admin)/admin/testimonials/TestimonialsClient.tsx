...
export default function TestimonialsClient() {
  ...
  const [targetDelete, setTargetDelete] = useState<Testimonial | null>(null);
  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-text-primary">Testimoni</h1>
          <p className="text-sm text-text-secondary mt-0.5">Kelola testimoni pelanggan di halaman utama</p>
        </div>
        <button
            ...
            >
              <div className="flex items-start justify-between gap-4">
                ...
                <div className="flex items-center gap-1 shrink-0">
                  ...
                  <button
                    onClick={() => { setTargetDelete(t); setShowDeleteDialog(true); }}
      ...
      <Dialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <DialogContent className="max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription>
              Testimoni dari &quot;{targetDelete?.customerName}&quot; akan dihapus. Tindakan ini tidak bisa dibatalkan.
            </DialogDescription>
          </DialogHeader>
