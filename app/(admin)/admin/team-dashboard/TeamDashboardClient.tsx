  ...
  return (
    <div className="space-y-5 pb-6">
      ...
      <div className="bg-white rounded-xl p-5 border border-admin-border">
        <h2 className="font-semibold text-text-primary mb-4">Progres Bulan Ini</h2>
        {monthlyProgress ? (
          <div className="space-y-3">
            <div className="flex items-end justify-between">
              <div>
                <p className="text-xs text-gray-500">Target</p>
                <p className="text-lg font-bold text-text-primary">{formatIDR(monthlyProgress.monthlyTarget)}</p>
              </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        <div className="bg-white rounded-xl p-5 border border-admin-border">
          <div className="flex items-center justify-between mb-4">
            <h2 className="font-semibold text-text-primary">Pipeline Pesanan</h2>
        ...
        <div className="bg-white rounded-xl border border-admin-border flex flex-col">
          <div className="px-5 py-4 border-b border-admin-border flex items-center justify-between">
            <h2 className="font-semibold text-text-primary">Pesanan Butuh Tindakan</h2>
            <a href="/admin/orders" className="text-xs text-brand-red hover:underline flex items-center gap-1">
              ...
              <tbody className="divide-y divide-gray-100">
                {actionOrders?.slice(0, 8).map(order => (
                  <tr key={order.id} className="hover:bg-gray-50 transition-colors">
                    <td className="px-4 py-3 text-xs font-mono font-semibold text-text-primary whitespace-nowrap">{order.orderNumber}</td>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        <div className="bg-white rounded-xl border border-admin-border">
          <div className="px-5 py-4 border-b border-admin-border flex items-center justify-between">
            <h2 className="font-semibold text-text-primary">Top 10 Produk Bulan Ini</h2>
              ...
              <tbody className="divide-y divide-gray-100">
                {topProducts?.map((product, idx) => (
                  <tr key={idx} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-4 py-3">
                      <p className="text-sm font-medium text-text-primary">{product.productNameId}</p>
        ...
        <div className="bg-white rounded-xl p-5 border border-admin-border">
          <div className="flex items-center justify-between mb-4">
            <h2 className="font-semibold text-text-primary">Inventori Alerts</h2>
      ...
      <div className="bg-white rounded-xl p-5 border border-admin-border">
        <div className="flex items-center justify-between mb-4">
          <h2 className="font-semibold text-text-primary">Pipeline B2B</h2>
      ...
      <div className="bg-white rounded-xl p-5 border border-admin-border">
        <div className="flex items-center justify-between mb-4">
          <h2 className="font-semibold text-text-primary">Program Poin Loyalitas</h2>
                ...
                {coupons?.slice(0, 6).map(coupon => {
                  ...
                  return (
                    <tr key={coupon.id} className="hover:bg-gray-50 transition-colors">
                      <td className="px-4 py-3 font-mono text-sm font-semibold text-text-primary">{coupon.code}</td>
      ...
      {/* ── Health Indicators ────────────────────────────────────────────── */}
      <div className="bg-white rounded-xl p-5 border border-admin-border">
        <h2 className="font-semibold text-text-primary mb-4">Indikator Kesehatan Bisnis</h2>
      ...
      <Dialog open={showEmailDialog} onOpenChange={setShowEmailDialog}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Kirim Reminder Email?</DialogTitle>
            <DialogDescription>
              Email pengingat akan dikirim ke {pointsSummary?.expiringSoon7d.toLocaleString()} pelanggan yang memiliki poin yang akan kadaluarsa dalam 7 hari ke depan.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            ...
            <Button
              ...
              onClick={async () => {
                ...
                try {
                  const res = await fetch('/api/admin/points/expiry-reminders', { method: 'POST' });
                  const json = await res.json();
                  if (json.success) {
