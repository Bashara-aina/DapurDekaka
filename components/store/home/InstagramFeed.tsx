...
const INSTAGRAM_GALLERY_IDS: Array<{ id: number; publicId: string; alt: string }> = [
  ...
  { id: 2, publicId: 'dapurdekaka/gallery/gallery-02', alt: 'Bakso frozen' },
  { id: 3, publicId: 'dapurdekaka/gallery/gallery-03', alt: 'Siomay Bandung' },
  { id: 4, publicId: 'dapurdekaka/gallery/gallery-04', alt: 'Lumpia crispy' },
  { id: 5, publicId: 'dapurdekaka/gallery/gallery-05', alt: 'Pangsit ayam' },
  { id: 6, publicId: 'dapurdekaka/gallery/gallery-06', alt: 'Menu catering' },
];
    ...
    <section className="py-12 px-4 bg-brand-cream">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-2 md:gap-3">
          {INSTAGRAM_GALLERY_IDS.map((item) => (
            <a
              key={item.id}
              href="https://instagram.com/dapurdekaka"
              target="_blank"
            ...
            >
              <Image
                src={`${CLOUDINARY_BASE}/${item.publicId}`}
                alt={item.alt}
                fill
